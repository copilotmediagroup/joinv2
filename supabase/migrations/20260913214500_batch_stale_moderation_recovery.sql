...
is 'Claims one user report after recovering at most 25 abandoned claims with SKIP LOCKED.';
comment on function public.claim_next_moderation_moment()
is 'Claims one Moment report after recovering at most 25 abandoned claims with SKIP LOCKED.';
