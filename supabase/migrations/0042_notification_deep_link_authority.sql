...
-- SIGNAL
-- Migration 0042
-- Authoritative notification deep-link resolver
-- ============================================================
-- A notification is only resolvable by its owner. Signal links
-- automatically follow conversion into a Plan when applicable,
-- so stale notification payloads never decide browser state.
-- ============================================================
