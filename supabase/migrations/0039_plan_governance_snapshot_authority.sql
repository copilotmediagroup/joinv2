...
-- SIGNAL
-- Migration 0039
-- Authenticated Plan governance snapshot authority
-- ============================================================
-- One read RPC returns only the governance state an active Plan
-- member is allowed to see. Browser never supplies a user id.
-- ============================================================
