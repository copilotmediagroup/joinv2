...
-- SIGNAL confirmation reconciler concurrency repair.
--
-- The reconciler owns authoritative confirmation-window mutations:
--   * assigned intent release / expiration,
--   * matched membership timeout,
--   * confirming -> coordinating,
--   * confirming -> forming.
--
-- Serialize those operations on the Signal group itself rather than
-- depending on every caller to acquire an undocumented external lock.
--
-- This is a forward-only repair. 0023 and 0024 remain historical.
