...
import type { SignalPlaceReview } from './places/contract'
...
const option =      timeOptions.find(
  ...
  return (
    <section className="signal-time-stage">
      ...
      <div className={lockedTime ? "signal-time-options signal-time-options-hidden" : "signal-time-options"}>
